...
//	Checkbox 클래스 객체로 라이도 버튼을 만들려면 Checkboxgruop 클래스 객체를 만들고 같은 그룹의 라디오 버튼을 만들때 
//	Checkbox 클래스 생성자의 3번째 인수로 넘겨주면 같은 그룹으로 묶인 라디오 버튼ㅇ ㅣ만들어진다
...
//		라디오 버튼은 선택 여부에 true를 여러개 저장해도 마지막에 true를 지정한 라디오 버튼만 선택되서 표시된다.
