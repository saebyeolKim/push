...
public class Client4 extends JFrame implements ActionListener,Runnable{
...
//		textArea.setEditable(false);	
	...
	public static void main(String[] args) {
		...
		try {
			...
			client.message = "192.168.1.4 서버의 10004번 포트포 접속 시도<br>";
			client.message += client.socket + "접속 성공<br>";
