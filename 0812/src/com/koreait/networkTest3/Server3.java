...
//			서버를 시작한다.
			...
			server.message = "192.168.1.4 서버의 10004번 포트로 서버 시작\n";
...
//			클라이언트와 메시지를 주고 받기 위해서 데이터 전송에 사용할 객체를 선언한다.
...
//		클라이언트와 통신이 종료되면 메시지를 입력할 수 없도록 텍스트 필드와 전송버튼을 비활성화 시킨다.
